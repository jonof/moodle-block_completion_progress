...
$string['errorinvalidblockinstanceid'] = 'Inappropriate block instance id given.';
...
$string['privacy:metadata:block_completion_progress:courseid'] = 'The course the percentage relates to.';
