...
$string['config_overviewcolumns'] = 'Overview columns';
...
$string['config_showemail'] = 'Show email column';
$string['config_showidnumber'] = 'Show matric number column';
$string['config_reminders'] = 'Reminder emails';
$string['config_reminderenabled'] = 'Enable reminder emails';
$string['config_reminderfrequency'] = 'Send reminder emails';
$string['config_reminderthreshold'] = 'Send when progress is below (%)';
...
$string['matricnumber'] = 'Matric Number';
...
$string['frequencydaily'] = 'Daily';
$string['frequencyweekly'] = 'Weekly';
$string['frequencymonthly'] = 'Monthly';
$string['frequencyyearly'] = 'Yearly';
$string['reminderemailsubject'] = 'Progress reminder for {$a->coursename}';
$string['reminderemailbody'] = 'Hello {$a->firstname},' . "\n\n" .
    'This is a reminder that your completion progress in {$a->coursename} is {$a->percent}%.' . "\n\n" .
    'Visit the course: {$a->courseurl}' . "\n\n" .
    'Thanks.';
$string['task_sendreminders'] = 'Send completion progress reminder emails';
